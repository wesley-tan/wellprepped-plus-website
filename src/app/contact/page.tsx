        ...
        <section className="bg-background-alt py-20">
          <div className="container mx-auto px-6">
            ...
            <div className="text-center">
              <h3 className="text-xl font-display font-semibold text-background mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`flex items-center gap-4 p-4 ${social.bgColor} ${social.hoverColor} text-white rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg`}
                  >
                    ...
                    <div className="text-left flex-1 min-w-0">
                      ...
                      <div className="text-white/90 text-xs truncate">{social.username}</div>
                    </div>
                  </a>
                ))}
              </div>
